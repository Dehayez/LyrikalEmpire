...
export const FormInput = ({ id, name, label, type, placeholder, value, onChange, onBlur, onKeyDown, required, min, pattern, maxLength, className, isWarning, spellCheck }) => {
    ...
    return (
        <div className={`form-group ${className || ''}`}>
            <input 
                ...
                onBlur={(e) => {
                    !e.target.value && e.target.nextSibling.classList.remove('form-group__label--active');
                    onBlur && onBlur(e);
                }}
                onKeyDown={onKeyDown}
